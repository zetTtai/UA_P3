...
public class CollectedItemsScore_PreP4Test {
	...
	public void testCollectedItemsScoreAndGetName() {
		...
		Score<ItemStack> score2= scPeter;
	...
	public void testCompareTo() {
		...
		try {
			...
			//Ahora Laura tiene más score, tiene que dar positivo porque peter es menor
			assertTrue(scPeter.compareTo(scLaura) > 0);
			
			scPeter.score(new ItemStack(Material.APPLE, 5));
			scPeter.score(new ItemStack(Material.APPLE, 5));
			assertTrue(scPeter.compareTo(scLaura) < 0);//Ahora devuelve negativo porque Peter es mayor
	...
	public void testToString() {
		try {
			...
			scPeter.score(new ItemStack(Material.GRASS,5));
			compareScores("Peter:28.0", scPeter.toString());
			scPeter.score(new ItemStack(Material.IRON_PICKAXE, 1));
			compareScores("Peter:28.5", scPeter.toString());
			scPeter.score(new ItemStack(Material.APPLE, 5));
			compareScores("Peter:48.5", scPeter.toString());
